                ...
                <ul class="nav navbar-nav flex">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/ManageProject">
                                Manage Project
                            </a>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/CreateProject">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/CreateUser">
                               	Create User
                            </a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/Task">Task</a>
                    </li>
                    <li class="nav-item dropdown">
